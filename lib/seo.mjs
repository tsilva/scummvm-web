...
export const HOME_TITLE = "Play classic adventure games online in your browser | ScummWEB";
...
export const HOME_HERO_TITLE = "Play classic adventure games online in your browser";
...
export function buildGameDescription(game) {
  return normalizeDescription(
    `Play ${game.displayTitle} online in your browser on ${SITE_NAME}. ${game.summary}`
  );
}
...
export function buildGameMetadata(game) {
  const title = `Play ${game.displayTitle} online in your browser | ${SITE_NAME}`;
...
export function buildPlayRouteMetadata(game) {
  return {
    title: `Play ${game.displayTitle} online in your browser | ${SITE_NAME}`,
